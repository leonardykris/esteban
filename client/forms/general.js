Template.personalDetailForm.helpers({
  ...
  countryCodeOptions: function() {
    codes = [
      ...
      {"value": "+672", "label": "Australian External Territories"},
      ...
      {"value": "+243", "label": "Congo, Dem. Rep. of (Zaire)"},
      ...
      {"value": "+596", "label": "French Antilles"},
      ...
      {"value": "+595", "label": "Guyana"},
      {"value": "+509", "label": "Haiti"},
      {"value": "+504", "label": "Honduras"},
      {"value": "+852", "label": "Hong Kong SAR China"},
      ...
      {"value": "+853", "label": "Macau SAR China"},
      ...
      {"value": "+1 808", "label": "Midway Island"},
      ...
      {"value": "+970", "label": "Palestinian Territory"},
  ...
  educationOptions: function() {
    educations = [
      ...
      {label: "MBA", value: "MBA"},
      {label: "MD", value: "MD"},
      {label: "MS/MA", value: "MS/MA"},
      {label: "BS/BA", value: "BS/BA"},
      {label: "JD/Law", value: "JD/Law"},
      {label: "Two-Year College", value: "Two-Year College"},
